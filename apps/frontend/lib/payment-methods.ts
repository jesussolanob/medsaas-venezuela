...
export const PAYMENT_METHOD_LABELS: Record<string, string> = {
  ...
  // migracion 20260911000001. Todo lo demas son alias de LECTURA para filas
  // viejas — se conservan porque la migracion no reescribio el historico.
  efectivo: 'Efectivo',
  ...
  binance: 'Binance',
  pos: 'POS',
  // Alias de LECTURA: valores en ingles escritos antes de la unificacion.
