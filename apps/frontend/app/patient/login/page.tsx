...
export default function PatientLoginPage() {
  ...
  return (
    <>
      ...
      `}</style>
      <div
        className="patient-redirect min-h-screen flex items-center justify-center px-6 py-12"
          ...
          <Link href="/" className="inline-flex items-center gap-2.5">
            ...
            <div className="text-left">
              <span className="font-extrabold text-lg" style={{ color: '#0F1A2A' }}>
                Delta <span style={{ color: '#06B6D4' }}>Salud</span>
              </span>
              <span
                className="text-[10px] font-medium tracking-[0.12em] uppercase block"
                style={{ color: '#97A3AF' }}
              >
                Medical CRM
              </span>
