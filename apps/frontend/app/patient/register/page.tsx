      ...
      <div className="w-full max-w-md text-center space-y-6">
        <Link href="/" className="inline-flex items-center gap-2.5">
          ...
          <div className="text-left">
            <span className="font-bold text-lg text-slate-900">Delta Salud</span>
        ...
        <Link
          href="/login"
          className="inline-flex items-center gap-2 text-teal-500 font-semibold text-sm hover:text-teal-600"
        >
