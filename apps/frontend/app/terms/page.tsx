        ...
        <div className="bg-white rounded-2xl border border-slate-200 p-8 sm:p-10">
          ...
          <div className="prose prose-slate max-w-none space-y-4 text-slate-700">
            ...
            <section>
              ...
              <p>
                Delta Salud provee una plataforma SaaS para que profesionales de la salud gestionen
                su práctica médica privada en Venezuela. El servicio incluye agenda, historia
                clínica electrónica, cobros, CRM y portal del paciente.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Durante el período de prueba el acceso es gratuito por 1 año. El servicio se ofrece
                "tal cual" sin garantías expresas. Reservamos el derecho de modificar
                funcionalidades.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Nos reservamos el derecho de suspender cuentas que violen estos términos, sin previo
                aviso.
              </p>
            </section>
