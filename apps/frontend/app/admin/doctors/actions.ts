...
// TODO Fase 4: createDoctor crea un usuario en el proveedor de auth (hoy Supabase
// Auth admin). En Etapa 1 con dev-stub no hay alta de usuarios; el backend admin
// no expone "crear doctor". Migrar cuando exista Auth0 + endpoint de provisioning.
