...
export default async function AdminFinanzasPage() {
  ...
  return (
    <div>
      <PageHead title="Finanzas" subtitle="Ingresos globales por suscripciones de la plataforma" />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3.5 mb-5">
        ...
        <StatCard
          ...
          delta={
            pendingCount > 0
              ? `${pendingCount} comprobante${pendingCount > 1 ? 's' : ''} sin revisar`
              : 'Todo al día'
          }
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1.6fr_1fr] gap-3.5 mb-5">
            ...
            {monthBuckets.map((b, i) => {
              ...
              return (
                <g key={i}>
                  ...
                  />
                  {isLast && (
                    <rect x={x} y={180 - h} width="50" height="6" rx="3" fill="var(--dh-coral)" />
                  )}
                </g>
              );
            })}
        ...
        <Card padding={24}>
          <p className="text-base font-bold mb-4" style={{ color: 'var(--dh-ink)' }}>
            Resumen del mes
          </p>
          ...
          <div className="space-y-4">
            <div>
              <div className="flex items-center justify-between mb-1">
                <span className="text-xs" style={{ color: 'var(--dh-gray-600)' }}>
                  Ingreso total
                </span>
                <span className="font-bold" style={{ fontFamily: 'var(--dh-font-mono)' }}>
                  ${mtdRevenue.toFixed(2)}
                </span>
              </div>
                ...
                allApproved.map((t: any, i: number) => {
                  ...
                  return (
                    <tr key={t.id} style={{ borderTop: '1px solid var(--dh-gray-100)' }}>
                      ...
                      >
                        {new Date(t.reviewed_at || t.created_at).toLocaleDateString('es-VE', {
                          day: '2-digit',
                          month: 'short',
                          year: 'numeric',
                        })}
                      ...
                      <td
                        ...
                        style={{ padding: '14px 20px', color: 'var(--dh-gray-600)' }}
                      >
                        {t.method.replace('_', ' ')}
                      </td>
