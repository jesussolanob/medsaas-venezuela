...
/**
 * Error boundary a nivel de segmento /admin. Ver app/doctor/error.tsx para el
 * porqué: captura errores sin reemplazar el shell raíz → la sesión del admin no se
 * pierde y no se expulsa a la landing.
 */
...
export default function AdminError({ error, reset }: SegmentErrorProps) {
  useEffect(() => {
