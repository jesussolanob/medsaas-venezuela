      ...
      <div className="max-w-3xl space-y-5">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-slate-500">
              Envía confirmaciones y recordatorios a tus pacientes
            </p>
          </div>
        ...
        <div className="bg-teal-50 border border-teal-200 rounded-xl p-4 flex items-start gap-3">
          ...
          <p className="text-sm text-teal-700">
            Selecciona las consultas y haz clic en <strong>Enviar recordatorio</strong> para
            notificar a tus pacientes por WhatsApp o Email.
          </p>
        </div>
            ...
            <div className="space-y-3">
              {filtered.map((consult) => {
                ...
                return (
                  <div
                    key={consult.id}
                    className={`bg-white border rounded-xl p-5 transition-all ${isSelected ? 'border-teal-300 shadow-sm' : 'border-slate-200'}`}
                  >
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1 flex-wrap">
                          ...
                          <span
                            className={`flex items-center gap-1 text-xs font-semibold px-2 py-0.5 rounded-full ${badge.cls}`}
                          >
                            {badge.icon}
                            {badge.label}
                          </span>
                        ...
                        {consult.chief_complaint && (
                          <p className="text-xs text-slate-400 mt-0.5">{consult.chief_complaint}</p>
                        )}
                        ...
                        {sent.length > 0 && (
                          <div className="flex flex-wrap gap-1.5 mt-2">
                            {sent.map((s) => (
                              <span
                                key={s.id}
                                className="flex items-center gap-1 text-[10px] text-emerald-600 bg-emerald-50 px-2 py-0.5 rounded-full font-semibold"
                              >
                      ...
                      <div className="flex flex-col gap-2 shrink-0">
                        ...
                        <button
                          ...
                          title={
                            !consult.patient_email ? 'Sin email registrado' : 'Enviar por email'
                          }
            ...
            <div className="px-6 py-5 space-y-5">
              <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4">
                ...
                <p className="text-sm text-emerald-700">
                  Los recordatorios se envían mediante <strong>WhatsApp Web</strong>. Al hacer clic
                  en &quot;WhatsApp&quot;, se abre una ventana con el mensaje listo para enviar al
                  paciente.
                </p>
              </div>
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 rounded-full g-bg flex items-center justify-center text-white text-xs font-bold shrink-0">
                      1
                    </div>
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">
                        ...
                        y escanea el código QR con tu teléfono.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">
                        Deja la pestaña de WhatsApp Web abierta para que los enlaces se abran
                        correctamente.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">
                        Los pacientes deben tener su número registrado con código de país (ej:
                        584141234567 para Venezuela).
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-500 mt-0.5">
                        Al hacer clic en el botón WhatsApp, se abre la conversación con el mensaje
                        ya escrito. Solo debes presionar enviar.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-4">
                ...
                <p className="text-xs text-amber-700">
                  Al enviar a múltiples pacientes, se abrirá una ventana de WhatsApp Web por cada
                  paciente. Esto es necesario porque WhatsApp no permite envío automatizado sin la
                  API Business. Deberás confirmar el envío de cada mensaje manualmente.
                </p>
              </div>

              <div className="bg-slate-50 border border-slate-200 rounded-xl p-4">
                <p className="text-sm font-bold text-slate-800 mb-1">
                  ¿Quieres envío 100% automático?
                </p>
                <p className="text-xs text-slate-500">
                  Para recordatorios automáticos sin intervención manual, necesitas integrar la{' '}
                  <strong>WhatsApp Business API</strong> de Meta. Esto requiere una cuenta de
                  negocio verificada en Meta Business Suite. Próximamente estará disponible esta
                  integración.
                </p>
              </div>
            </div>
