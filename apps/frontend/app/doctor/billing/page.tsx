...
export default function BillingPage() {
  ...
  const [genericPatient, setGenericPatient] = useState<GenericPatient>({
    name: '',
    phone: '',
    email: '',
  });
  ...
  function addItem(service?: Service) {
    if (service) {
      ...
      setItems((prev) => [
        ...prev,
        { id: Date.now().toString(), description: '', qty: 1, unit_price: 0 },
      ]);
    }
  }
    ...
    try {
      ...
      setDocStats((prev) => ({
        ...
        [docTypeMap[docType] === 'factura' ? 'totalFacturas' : 'totalPresupuestos']:
          prev[docTypeMap[docType] === 'factura' ? 'totalFacturas' : 'totalPresupuestos'] +
          subtotal,
      }));
  ...
  const effectivePatient = genericMode
    ? {
        name: genericPatient.name || 'Paciente',
        phone: genericPatient.phone,
        email: genericPatient.email,
      }
    : selectedConsult
      ? {
          name: selectedConsult.patient_name,
          phone: selectedConsult.patient_phone ?? '',
          email: selectedConsult.patient_email ?? '',
        }
      : null;
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={fi + ' pl-9 text-xs py-2'}
                    />
                  </div>
                </div>
              </div>
            ...
            <div className="no-print bg-white border border-slate-200 rounded-xl p-5 space-y-3">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    value={genericPatient.name}
                    onChange={(e) => setGenericPatient((p) => ({ ...p, name: e.target.value }))}
                ...
                <div>
                  ...
                  <input
                    value={genericPatient.phone}
                    onChange={(e) => setGenericPatient((p) => ({ ...p, phone: e.target.value }))}
                    placeholder="+58 412..."
                    className={fi}
                  />
                </div>
              ...
              <div>
                ...
                <input
                  type="email"
                  value={genericPatient.email}
                  onChange={(e) => setGenericPatient((p) => ({ ...p, email: e.target.value }))}
          ...
          {selectedConsult || (genericMode && genericPatient.name.trim()) ? (
            <>
              ...
              <div ref={printRef} className="bg-white border border-slate-200 rounded-xl p-8">
                    ...
                    {doctorProfile?.logo_url ? (
                      ...
                      <div
                        style={{
                          ...
                          height: 48,
                          borderRadius: 12,
                          background: 'linear-gradient(135deg,#00C4CC,#0891b2)',
                          display: 'flex',
                          alignItems: 'center',
                ...
                >
                  <div
                    style={{ background: '#f8fafc', borderRadius: 12, padding: 16, opacity: 0.8 }}
                  >
                    <div
                      style={{
                        fontSize: 9,
                ...
                {selectedConsult && (
                  ...
                  >
                    <div>
                      ...
                      >
                        {selectedConsult.consultation_code}
                      </div>
                    </div>
                    <div>
                      <div
                      ...
                      <div style={{ fontSize: 12, fontWeight: 600, color: '#0f766e' }}>
                        {new Date(selectedConsult.consultation_date).toLocaleDateString('es-VE', {
                          day: 'numeric',
                          month: 'long',
                          year: 'numeric',
                        })}
                  ...
                  <div style={{ width: 320 }}>
                    ...
                    >
                      ...
                      {bcvRate && (
                        ...
                        >
                          Bs.{' '}
                          {(subtotal * bcvRate).toLocaleString('es-VE', {
                ...
                {notes && (
                  <div
                    style={{ marginTop: 24, background: '#f8fafc', borderRadius: 10, padding: 14 }}
                  >
                    <div
                      style={{
                        fontSize: 9,
              ...
              <div className="no-print bg-white border border-slate-200 rounded-xl p-5 space-y-4">
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
                  ...
                  <div className="flex gap-2 flex-wrap">
                    ...
                    <button
                      onClick={() => addItem()}
                      className="g-bg flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-bold text-white hover:opacity-90 shrink-0"
                    >
                ...
                <div className="space-y-2 overflow-x-auto">
                  {items.map((item) => (
                    <div
                      key={item.id}
                      className="flex items-center gap-1 sm:gap-2 flex-col sm:flex-row min-w-min sm:min-w-0"
                    >
                      <input
                        value={item.description}
                        onChange={(e) => updateItem(item.id, 'description', e.target.value)}
                        placeholder="Descripción"
                        className={fi + ' flex-[3] min-w-[150px]'}
                      />
                      <input
                        type="number"
                        min="1"
                        ...
                        className={fi + ' flex-[1] text-center w-20'}
                      />
                      <input
                        type="number"
                        min="0"
                        ...
                        className={fi + ' flex-[1] text-right w-20'}
                      />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    placeholder="Indicaciones, condiciones de pago, validez del presupuesto..."
              ...
              <div className="no-print flex flex-col sm:flex-row gap-2 sm:gap-3">
                <button
                  onClick={() => {
                    ...
                    setGenericPatient({ name: '', phone: '', email: '' });
                  }}
    ...
    <>
      ...
      <div className="max-w-4xl space-y-5">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-500 mt-1">
              Genera facturas, presupuestos, informes y recetas en PDF
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          >
            <div className="cta-btn w-12 h-12 rounded-xl flex items-center justify-center mb-4 group-hover:shadow-lg">
        ...
        <div className="bg-white border border-slate-200 rounded-xl overflow-hidden">
          <div className="px-5 py-4 border-b border-slate-100 flex items-center justify-between">
            <p className="text-sm font-semibold text-slate-700">
              Consultas disponibles para facturar
            </p>
            <div className="relative">
              ...
              <input
                ...
                onChange={(e) => setSearch(e.target.value)}
                placeholder="Buscar..."
                className="pl-8 pr-3 py-1.5 text-xs border border-slate-200 rounded-lg outline-none focus:border-teal-400 bg-white"
              />
            </div>
          </div>
          {loading ? (
            ...
            filteredConsults.map((c, i) => (
              <div
                key={c.id}
                className={`flex items-center gap-4 px-5 py-4 ${i < filteredConsults.length - 1 ? 'border-b border-slate-100' : ''}`}
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs text-slate-400 flex items-center gap-1.5">
                    <span className="font-mono">{c.consultation_code}</span> ·{' '}
